...
| Modelo | **Anthropic**, por **consumo de cuenta, sin clave de API**. **Haiku 4.5 en todos los roles** desde el 2026-09-24 | **Nuestro** | **Haiku 4.5 en todos los roles.** P-02 separo al juez a proposito —Opus juzgaba— porque **un juez que comparte modelo con quien escribió tiende a aprobar su propio estilo**. Se unifica el **2026-09-24 por coste, con la cifra medida delante**: la corrida real da **~8,8 USD por novela** con el reparto y **~1,5 toda en Haiku**, y la diferencia es entera del cambio de modelo. **Lo que se pierde:** la distancia de `RF-JUZ-05` se medira con un juez que comparte modelo, familia y entrenamiento con el autor, asi que **saldra mejor de lo que el sistema merece**. La constante `MODELO_JUEZ` se mantiene separada para poder revertirlo con una linea. Sin cargo por llamada, el **coste se deriva** de los tokens y la tarifa declarada |
