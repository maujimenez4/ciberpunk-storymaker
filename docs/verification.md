...
| La edad de un personaje concuerda con su fecha de nacimiento en cada evento | CLAUDE §8, regla 13 · examen §5c | **T** | Segunda invariante de Lean, misma puerta |
...
| Ninguna palabra vetada llega al capítulo aceptado | CLAUDE §8, regla 12 · examen §7 | **T** | Comparación léxica normalizada en código, con tests de cada nivel de lista y de variante con acento o plural. **Caza la palabra, no la alusión** (§7) |
