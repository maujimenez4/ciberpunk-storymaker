...
Propuesta formal de **Qaracter** a **Regalos con Historia S.L.** (cliente ficticio): un sistema
...
| Fichero | Qué es |
| --- | --- |
| `storymaker-deck.pdf` | El deck principal: 15 slides |
